...
class SmallConvNet(nn.Module):
    def __init__(self, 
                 ...
                 convolution_kernel_output_dim=6,
                 max_pool_width=2):
        super().__init__()
        ...
        self.linear_layer_1 = nn.Linear(int(convolution_layer_output_size / max_pool_width)**2 * convolution_kernel_output_dim, 200) #classifier
        self.linear_layer_2 = nn.Linear(200, 50) #classifier
